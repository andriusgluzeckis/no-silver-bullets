...
var boxes = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".box");
    ...
    this.menuTriggers.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        if (!_this.isOpen) {
          // if closed
          _this.isOpen = true;
          if (_this.menu.classList.contains(_this.inActiveClass) && !_this.menu.classList.contains(_this.activeClass)) {
            _this.menu.classList.remove(_this.inActiveClass);
            _this.menu.classList.add(_this.activeClass);
          }
        } else {
          // if opened
          if (_this.menu.classList.contains(_this.activeClass) && !_this.menu.classList.contains(_this.inActiveClass)) {
            _this.menu.classList.add(_this.inActiveClass);
...
var Scroll = /*#__PURE__*/function () {
  ...
  function Scroll() {
    ...
    window.addEventListener('scroll', function (event) {
      _this.checkScrollDirection(event);
      if (_this.isScrollDown) {
        if (!_this.menuTrigger.classList.contains('opacity-0')) {
          setTimeout(function (event) {
            _this.menuTrigger.classList.add('opacity-0');
            _this.menuTrigger.classList.add('pointer-events-none');
          }, _this.delay);
        }
      } else {
        if (_this.menuTrigger.classList.contains('opacity-0')) {
          setTimeout(function (event) {
            _this.menuTrigger.classList.remove('opacity-0');
            _this.menuTrigger.classList.remove('pointer-events-none');
          }, _this.delay);
        }
      }
    });
  ...
  return _createClass(Scroll, [{
    ...
    value: function checkScrollDirection(event) {
...
var ClientsSlider = /*#__PURE__*/_createClass(function ClientsSlider(clientsSliderWrapper) {
  ...
  this.clientsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](this.clientsSliderElement, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
    forceLoop: true,
    loop: true,
    freeMode: true,
    spaceBetween: 80,
  ...
  }), "autoHeight", false), "freeMode", true), "speed", 3000), "freeModeMomentum", false), "breakpoints", {
    768: {
      slidesPerView: 4
    },
    1024: {
...
var CaseStudiesSlider = /*#__PURE__*/_createClass(function CaseStudiesSlider(sliderWrapper) {
  _classCallCheck(this, CaseStudiesSlider);
  ...
  this.slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](this.sliderElement, {
    slidesPerView: 1,
    loop: true,
    speed: 300,
    pagination: {
...
var WorkSliderNavigation = /*#__PURE__*/function () {
  function WorkSliderNavigation(navItem, closeAllNavItems, slider) {
    var _this = this;
    _classCallCheck(this, WorkSliderNavigation);
    this.navItem = navItem;
    this.closeAllNavItems = closeAllNavItems;
    this.slider = slider;
    this.navItem.addEventListener('click', function (event) {
      event.preventDefault();
      _this.index = event.target.dataset.index;
      _this.slider.slideToLoop(_this.index, 300, null);
      _this.closeAllNavItems();
      _this.active();
    });
  }
  return _createClass(WorkSliderNavigation, [{
    key: "active",
...
var WorkSlider = /*#__PURE__*/function () {
  function WorkSlider(sliderWrapper) {
    var _this2 = this;
    ...
    this.navigationItemsList = _toConsumableArray(this.navigationItems).map(function (item) {
      return new WorkSliderNavigation(item, function () {
        return _this2.disableNav();
      }, _this2.slider);
    });
  }
  return _createClass(WorkSlider, [{
    key: "disableNav",
    value: function disableNav() {
      this.navigationItemsList.forEach(function (trigger) {
        return trigger.close();
      });
    }
  }]);
}();
var Sliders = /*#__PURE__*/_createClass(function Sliders() {
...
/* harmony import */ var _js_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/animations */ "./src/js/animations.js");
...
window.THEME_NAME = {
  scroll: new _js_scroll__WEBPACK_IMPORTED_MODULE_3__["default"](),
  menu: new _js_menu__WEBPACK_IMPORTED_MODULE_4__["default"](),
  sliders: new _js_sliders__WEBPACK_IMPORTED_MODULE_5__["default"]()
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkno_silver_bullets"] = self["webpackChunkno_silver_bullets"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/styles"], () => (__webpack_require__("./src/main.js")))
